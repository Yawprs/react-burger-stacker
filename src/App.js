...
class App extends Component {
  ...
  addToBurger = (e) => {
    ...
    // create an object with name and color properties that collects vals from e.target
    let newIngredient = {name: e.target.innerText, color: e.target.style.backgroundColor}
    // push object to currentBurger array
    currentBurger.push(newIngredient)
    // set state of burgerIngredients to currentBurger
